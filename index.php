...
<body>
	<div class="form-group">
		<div id="top">
			...
			<div id="b-day">happy birthday!</div>
				<div id="color-title">Color:</div>
					<div id="colorSelector"><div id="color-input"></div></div>
		</div>
	...
	<div class="line-outline"></div>
		...
		<div id="below"><div id="message-title">Message:</div><div id="message"></div></div>
			<div class="col-lg-g">
				<textarea id="message-input" rows="1" placeholder="Type your message text here!"></textarea>
			</div>
